...
; This file is auto-generated. Changes made to it will be lost next time
; project settings are changed, or when the project is reopened.
;
...
;
; In the list of files passed to the assembler, this file is the first one.

...
#define SIM_E_NOT_SUPPORTED_WHILE_SIMULATION_RUNNING  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x201)
#define SIM_E_SNAPSHOT_FILE_WRONG_SIZE                MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x202)
#define SIM_E_BINARY_FILE_TOO_LARGE                   MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x203)
#define SIM_E_BINARY_FILE_EMPTY                       MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x204)
